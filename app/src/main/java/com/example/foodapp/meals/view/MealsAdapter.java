...
public class MealsAdapter extends RecyclerView.Adapter<MealsAdapter.BeefViewHolder> {
    ...
    public MealsAdapter(Context context, List<BeefMealsData> beefMealsList, OnFavMealClickListener listener ) {
    ...
    public MealsAdapter(Context context, List<BeefMealsData> beefMealsList) {
        this.context = context;
        this.beefMealsList = beefMealsList;
        sharedPreferences = context.getSharedPreferences(LoginActivity.PREFERENCE , Context.MODE_PRIVATE);
    ...
    public BeefViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        BeefViewHolder beefViewHolder = new BeefViewHolder(view);
    ...
    class BeefViewHolder extends RecyclerView.ViewHolder {
